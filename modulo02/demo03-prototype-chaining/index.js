...
console.log('fn.__proto__', fn.__proto__ === Function.prototype);
assert.deepStrictEqual(fn.__proto__, Function.prototype);

// actually __proto__ of Object.prototype is null!!
...
// will not work! (lifecycle)
// console.log('Manager.prototype.salary()', Manager.salary())

// if don't call 'new', __proto__ will be always instance of "Function" without inheriting new classes
// to access them, can use 'prototype' directly like this:
...
// when call 'new', '__proto__' receives 'prototype'
console.log('manager.__proto__', new Manager().__proto__);
console.log('manager.salary()', new Manager().salary());
